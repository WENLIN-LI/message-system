...
export const StatusMessage: React.FC<StatusMessageProps> = ({ error, success, setError }) => {
  ...
  return (
    <>
      {error && (
        <div role="alert" aria-atomic="true" className="bg-danger-50 border border-danger-300 p-2 text-danger">
      ...
      {!error && success && (
        <div role="status" aria-atomic="true" className="bg-success-50 border border-success-300 p-2 text-success">
          <div className="max-w-[1400px] mx-auto px-4 flex items-center gap-2 text-xs">
