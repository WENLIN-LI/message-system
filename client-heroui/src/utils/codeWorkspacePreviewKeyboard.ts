export type CodeWorkspacePreviewAutomationModifier = 'Alt' | 'Control' | 'Meta' | 'Shift';

export interface CodeWorkspacePreviewAutomationPressInput {
  readonly key: string;
  readonly modifiers?: readonly CodeWorkspacePreviewAutomationModifier[];
}
...
export interface CodeWorkspacePreviewAutomationKeyEvent {
...
export interface CodeWorkspacePreviewAutomationKeySequence {
  readonly keyDown: CodeWorkspacePreviewAutomationKeyEvent;
  readonly keyUp: CodeWorkspacePreviewAutomationKeyEvent;
  readonly signal: {
    readonly kind: 'key';
    readonly key: string;
    readonly code: string;
...
const macEditingCommands = (
  code: string,
  modifiers: CodeWorkspacePreviewAutomationPressInput['modifiers'],
): readonly string[] => {
  const shortcut = [
...
function resolveKeyDefinition(input: CodeWorkspacePreviewAutomationPressInput): KeyDefinition {
...
export function makeCodeWorkspacePreviewAutomationKeySequence(
  input: CodeWorkspacePreviewAutomationPressInput,
  options?: { readonly isMac?: boolean },
): CodeWorkspacePreviewAutomationKeySequence {
