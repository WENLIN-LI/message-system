...
This is a Message System capability exposed to Coco as a tool. Coco core should only see a normal tool schema; Message System owns authorization, persistence, object storage, and the public serving route.
...
- The publish API must require a scoped bearer token issued by Message System for one Coco turn.
