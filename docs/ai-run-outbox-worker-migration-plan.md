...
Move Message System AI generation from a socket-handler-owned process to a durable, observable, retryable run model without changing the user-facing streaming experience.
